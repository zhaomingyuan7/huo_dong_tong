...
Bid.storage_bid_list_when_click_start = function(){
    ...
    var bid_list_name = _.filter(bid_lists,
...
Bid.save_bid_sign_status = function(name){
    ...
    _.find(bid_lists,function(bid_lists){
        if( bid_lists.activity == localStorage.activities_sign && bid_lists.name == localStorage.current_bid_name){
